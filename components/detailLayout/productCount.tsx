    ...
    <>
      ...
      <div className="flex items-center p-2 border w-fit rounded-xl gap-x-6">
        <button
          ...
          onClick={Dec}
          className={`${
            much === 1 ? "bg-gray-300" : "bg-orange-500"
        ...
        <button
          onClick={Add}
          className="bg-orange-500 w-6 h-6 flex duration-300 active:scale-90 items-center justify-center text-white rounded-md text-xl font-bold"
        >
          +
        </button>
      </div>
      <div className="pt-2">
        {note ? (
          <input
            className="p-2 border border-gray-300 rounded-xl outline-none focus:border-orange-500 duration-300"
