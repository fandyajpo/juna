...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className={`flex bg-orange-500 backdrop-blur-md shadow-md fixed top-0 z-20 justify-center w-full items-center h-fit`}
      >
        ...
        <div className="w-full md:max-w-2xl lg:max-w-4xl xl:max-w-7xl duration-1000 h-16 md:h-20 flex justify-center items-center  shadow-sm gap-x-2 px-2">
          ...
          >
            <Link href={"/"}>
              <p className="text-white font-extrabold text-2xl">Eiger</p>
            </Link>
          </motion.div>
          {RouteBack}
          <button
